...
class AvatarListViewController: BaseViewController {
    ...
    lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(AvatarListCellCell.self, forCellWithReuseIdentifier: "AvatarListCellCell")
...
extension AvatarListViewController:UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "AvatarListCellCell", for: indexPath) as! AvatarListCellCell
